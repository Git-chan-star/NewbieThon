...
> 고려대학교 NewbieThon 제출 버전 `v1.0.1`
> Android 패키지 `com.newbiethon.itgu`
...
운영 Supabase DB, 즉시 로그인 회원가입, 공고 지원, 관리자 기능과 Android APK `v1.0.1` 빌드를 검증했습니다. 실제 공개 배포 전에는 학교·사업자 인증, 푸시 알림, 개인정보·결제·세금 정책을 별도로 확정해야 합니다.
